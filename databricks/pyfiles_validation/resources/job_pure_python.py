"""
Job definition for testing pure Python module format.

Tests pure .py files wrapped in user_modules wheel.
"""
...
def create_pure_python_test_job(
    job_name: str = "[dev cluster] pure-python-test",
    volume_base_path: str = DEFAULT_VOLUME_BASE,
    cleanup_enabled: bool = DEFAULT_CLEANUP_ENABLED,
) -> Job:
    """
    Create job for testing pure Python module format.
    ...
    """
    # Paths
    input_zip_path = f"{volume_base_path}/input/pure_python.zip"
    ...
    test_script = "file:${workspace.file_path}/src/test_pure_python.py"
    ...
    return Job(
        ...
        tasks=[
            ...
            Task(
                ...
                description="Convert pure Python zip to wheelhouse format",
            ...
            # Task 2: Test pure Python modules on driver + workers
            Task(
                task_key="test_dependencies",
                description="Verify user modules work on driver and workers",
...
job_pure_python_test = create_pure_python_test_job()
