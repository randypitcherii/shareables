...
variable "uc_external_id" {
  description = "External ID for Unity Catalog storage credential trust policy"
  type        = string
  default     = "47179a3c-367e-4302-8abb-62eb85b97aa1"
  # This is generated by Databricks when creating the storage credential
  # Get it from: databricks storage-credentials describe htd_storage_credential
}
...
variable "tags" {
  ...
  type        = map(string)
  default = {
    Project     = "Hive to Delta Migration"
    Environment = "dev"
    ManagedBy   = "Terraform"
  }
}
