...
A customer needs to read data stored in Google Cloud Storage (GCS) from an AWS-hosted Databricks workspace. This experiment evaluates five approaches across both serverless and classic compute to determine viable cross-cloud data access patterns.
