...
This experiment tests methods for reading data from Google Cloud Storage (GCS) using a Databricks workspace hosted on AWS. The motivation is a cross-cloud scenario where data lives in GCS but the Databricks workspace runs on AWS.
